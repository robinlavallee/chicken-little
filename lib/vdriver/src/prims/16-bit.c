/*
 ...
 This block is here jsut to grab your attention.  Everyone knows that all the
...
// programming technique, you can make this module 32-bit friendly (or very nearly
// so) just by altering this one define.

#ifndef BYTESPP
#define BYTESPP 2
#endif

#include "prims.h"             // The magic behind the mystery of the UCAST 

// =====================================================================================
    void __inline gfx16_line(const VD_SURFACE *vs, int xstart, int ystart, int xend, int yend, int color)
// =====================================================================================
...
// =====================================================================================
    void __inline gfx16_hline(const VD_SURFACE *vs, int xstart, int ystart, int ylen, int color)
// =====================================================================================
{
...
// =====================================================================================
    void __inline gfx16_vline(const VD_SURFACE *vs, int xstart, int ystart, int ylen, int color)
// =====================================================================================
{
    register UCAST *scrn;
...
// =====================================================================================
    void gfx16_rect(const VD_SURFACE *vs, const VRECT *rect, int color)
// =====================================================================================
{
    int   ytmp;
...
// =====================================================================================
    void gfx16_TileOpaque(const VD_SURFACE *vs, const UBYTE *tile_bitmap, UBYTE *tile_scrnptr)
// =====================================================================================
{
    unsigned int ltemp;
...
// =====================================================================================
    void gfx16_TileTrans(const VD_SURFACE *vs, const UBYTE *tile_bitmap, UBYTE *tile_scrnptr)
// =====================================================================================
{
...
// =====================================================================================
    void gfx16_TileFunky(const VD_SURFACE *vs, const UBYTE *tile_bitmap, UBYTE *tile_scrnptr)
// =====================================================================================
{
    UBYTE        cc, *see;
    UCAST        ww;
