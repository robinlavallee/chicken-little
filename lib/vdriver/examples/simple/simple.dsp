...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "$(MMIOO)\include" /I "$(VDRIVER)\include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /YX /FD $(VECTORC) /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "$(MMIO)\include" /I "$(VDRIVER)\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /YX /FD /GZ /c
