...
static struct
{
    ...
    void (*handler)(int error_this, CHAR *my_bad);
} errinfo;
...
static void mmlogv(const CHAR *fmt, ... )
{
}
...
void (*_mmlog)  (const CHAR *fmt, ... ) = mmlog;
void (*_mmlogv) (const CHAR *fmt, ... ) = mmlogv;
...
// ===========================================================================
void _mmlog_init(void (*log)(const CHAR *fmt, ... ), void (*logv)(const CHAR *fmt, ... ))
// ===========================================================================
{
    _mmlog  = log;
    _mmlogv = logv;
...
// ===========================================================================
void _mmerr_sethandler(void (*func)(int, CHAR *))
// ===========================================================================
{
