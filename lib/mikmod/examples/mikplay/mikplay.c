...
// =====================================================================================
    void errorhandler(int errnum, CHAR *errmess)
// =====================================================================================
...
// =====================================================================================
{
   ...
   {   // there was an error in the commandline, or there were no true
    ...
    device = Mikmod_Init(44100, 2400, NULL, MD_STEREO, CPU_AUTODETECT,
    ...
    {   printf("File    : %s\n",argv[cursong+1]);
        ...
        {   CHAR c;
            ...
            {   printf("\rsngpos:%d patpos:%d sngspd %d bpm %d    ",
                            mp->sngpos,mp->patpos,mp->sngspd,mp->bpm);
                fflush(stdout);
            }

        }

        Player_FreeSong(mp);    // stop playing and free up
